      ...
      <Row>
        <Col className="mt-5" xs="12">
          ...
          <p>
            ...
            solely to information collected by this web site. It will notify
            you of the following:
          </p>
          <ol>
            <li>
              What personally identifiable information is collected from
              you through the web site, how it is used and with whom it may be shared.
            </li>
        ...
        <Col className="mt-3" xs="12">
          <p>
            ...
            you should contact us immediately via our
